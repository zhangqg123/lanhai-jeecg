...
*表单的高度,表单的宽度
**/
<#if tableType=="2">var ${config_id}Fw = 900,${config_id}Fh = 450;<#else><#if tableType=="2">var ${config_id}Fw = 950,${config_id}Fh = 450;<#else>var ${config_id}Fw = 700,${config_id}Fh = 400;</#if></#if>
					...
					<#list config_fieldList  as x>  
						 {	field:'${x['field_id']}',
						 	...
						 	formatter:function(value,rec,index){
						 		...
						 		if(value.indexOf(".jpg")>-1 || value.indexOf(".gif")>-1 || value.indexOf(".png")>-1 || value.indexOf(".jpeg") > -1){
