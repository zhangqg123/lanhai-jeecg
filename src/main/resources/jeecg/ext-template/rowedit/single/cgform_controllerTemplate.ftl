...
public class ${entityName}Controller extends BaseController {
	...
	@ResponseBody
	public AjaxJson saveRows(${entityName}Entity page){
		String message = null;
		List<${entityName}Entity> ${entityName?uncap_first}List=page.get${entityName}List();
		AjaxJson j = new AjaxJson();
		if(CollectionUtils.isNotEmpty(${entityName?uncap_first}List)){
			for(${entityName}Entity ${entityName?uncap_first}:${entityName?uncap_first}List){
