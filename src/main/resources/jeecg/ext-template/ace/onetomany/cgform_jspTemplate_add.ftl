			        ...
			        <#list pageColumns as po>
					  ...
					  <#-- update--end--author:Yandong date:20180320 for:TASK #2574 【代码生成器】代码生成效果有问题  2. 有附件的，应该弹窗宽一些  -->
							...
							<#elseif po.showType=='radio' || po.showType=='select' || po.showType=='checkbox' || po.showType=='list'>	 
								...
								<@dictSelecttag po = po namePre="" valuePre = "" formStyle="aces" opt="add" />
					...
					<div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						    <#if po.showType=='textarea'>
						  	 	<#-- update--begin--author:zhangjiaqiang Date:20170509 for:修订生成页面乱 -->
						  	 	<#-- update--begin--author:gj_shaojc Date:20180315 for:TASK #2548 【代码生成器】样式问题-->
						  	 	<textarea id="${po.fieldName}" class="form-control" rows="6" cols="22" <@datatype validType="${po.fieldValidType!''}" isNull="${po.isNull}"  type="${po.type}" mustInput="${po.fieldMustInput!''}" /> name="${po.fieldName}"></textarea>
						 ...
						 <#assign check = 0 >
						  ...
						  <td align="left">
							  ...
							  <#-- update--begin--author:zhangjiaqiang Date:20170509 for:修订生成页面乱 -->
								...
								<#elseif po.showType=='radio' || po.showType=='select' || po.showType=='checkbox' || po.showType=='list'>
									<#-- update-begin-author:taoyan Date:20180519 for:dictselect改用标签便于以后统一修改 -->
									<@dictSelecttag po = po namePre="${sub.entityName?uncap_first}List[#index#]." valuePre = "" formStyle="aces" opt="add" />
									<#-- update-end-author:taoyan Date:20180519 for:dicselect改用标签便于以后统一修改 -->
								<#elseif po.showType=='date'>
									<#-- update--begin--author:zhangjiaqiang Date:20170509 for:修订生成页面乱 -->
