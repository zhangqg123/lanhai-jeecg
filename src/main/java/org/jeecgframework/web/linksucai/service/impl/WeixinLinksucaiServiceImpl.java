package org.jeecgframework.web.linksucai.service.impl;
...
import org.jeecgframework.web.linksucai.oauth2.def.WeiXinOpenConstants;
...
// 		sql  = sql.replace("#{UUID}",String.valueOf(t.getId()));
 		return sql;
 	}
 	...
 	public <T> List<T>  getLinksucaiList()
 	{
		...
		cq.eq("accountid", ResourceUtil.getConfigByName("qywxAccountId"));
...
// 	}
	...
	public String getInnerLink(String linkSucaiId) {
		...
		String inner_link = baseurl+"/weixinLinksucaiController.do?link&id="+ linkSucaiId + "&accountid="+ResourceUtil.getConfigByName("qywxAccountId");
		return inner_link;
	}
}