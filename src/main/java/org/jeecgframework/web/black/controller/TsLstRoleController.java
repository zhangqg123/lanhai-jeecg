 ...
 */
@Controller
@RequestMapping("/tsLstRoleController")
@Api(value = "测试用角色服务", description = "测试用角色服务接口", tags = "sysLstRoleAPI")
public class TsLstRoleController extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TsLstRoleController.class);
