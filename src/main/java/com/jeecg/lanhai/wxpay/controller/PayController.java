package com.jeecg.lanhai.wxpay.controller;

import com.alibaba.fastjson.JSONObject;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.jeecg.lanhai.wxpay.constant.Constant;
import com.jeecg.lanhai.wxpay.constant.Signature;
import com.jeecg.lanhai.wxpay.entity.PayInfo;
import com.jeecg.lanhai.wxpay.entity.SignInfo;
...
public class PayController {
    ...
    public String prePay(String code, ModelMap model, HttpServletRequest request) {
        ...
        if(StringUtils.isBlank(openId)) {
            ...
            if(StringUtils.isBlank(prepayId)) {
    			...
    			signInfo.setNonceStr(RandomUtils.generateMixString(32));
    ...
    private String getOpenId(String code) {
		LhSAccountEntity lhSAccount=lhSAccountService.getByAppId(Constant.APP_ID);
		//微信小程序Secret
