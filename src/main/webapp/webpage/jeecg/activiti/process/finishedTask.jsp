...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="finishedTask" checkbox="false" pagination="true" fitColumns="false" title="任务列表" actionUrl="activitiController.do?finishedTaskDataGrid" idField="id" fit="true" queryMode="group" queryBuilder="true">
