...
<t:formvalid formid="formobj" dialog="true" layout="table" action="leaveController.do?reApplyTask">
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right" width="15%" nowrap><label class="Validform_label"> 调整请假原因: </label></td>
			<td class="value" width="85%">
				<input id="id" name="id" type="hidden" value="${leave.id}">			
				<input id="reason" class="inputxt" name="reason" value="${leave.reason}" datatype="s2-10" />
