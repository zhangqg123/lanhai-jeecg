...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgDemoExcelController.do?doUpdate" tiptype="1" >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>姓名：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="name" name="name" maxlength="100" type="text" class="form-control" ignore="ignore"  value='${jeecgDemoExcelPage.name}' />
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>生日：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="birthday" name="birthday" type="text" style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;"  class="form-control" onClick="WdatePicker()" ignore="ignore"  value='<fmt:formatDate value='${jeecgDemoExcelPage.birthday}' type="date" pattern="yyyy-MM-dd"/>' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>测试替换：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="fdReplace" name="fdReplace" maxlength="255" type="text" class="form-control" ignore="ignore"  value='${jeecgDemoExcelPage.fdReplace}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3 text-center">
			          	<b>测试转换：</b>
			          		...
			          		<div class="col-xs-3">
								<input id="fdConvert" name="fdConvert" maxlength="255" type="text" class="form-control" ignore="ignore"  value='${jeecgDemoExcelPage.fdConvert}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
