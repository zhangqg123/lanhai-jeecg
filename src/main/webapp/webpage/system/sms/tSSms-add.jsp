  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSSmsController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="esSender" name="esSender" type="text" style="width: 150px" class="inputxt" value="${tSSmsPage.esSender}">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							<input id="esSendtime" name="esSendtime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" >    
							<span class="Validform_checktip"></span>
