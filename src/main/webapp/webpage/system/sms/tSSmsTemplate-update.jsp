  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSSmsTemplateController.do?doUpdate" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
									<t:dictSelect field="templateType" type="list" typeGroupCode="msgTplType" 
										defaultVal="${tSSmsTemplatePage.templateType}" hasLabel="false"  title="模板类型" extendJson="{\"datatype\":\"*\"}" ></t:dictSelect>     
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="templateContent" style="width:600px;;height:100px" class="inputxt" rows="6" name="templateContent">${tSSmsTemplatePage.templateContent}</textarea>
							<span class="Validform_checktip"></span>
