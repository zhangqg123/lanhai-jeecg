  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSSmsController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="esTitle" name="esTitle" type="text" style="width: 150px" class="inputxt"  value='${tSSmsPage.esTitle}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="esReceiver" name="esReceiver" type="text" style="width: 150px" class="inputxt"   value='${tSSmsPage.esReceiver}'>
							<span class="Validform_checktip"></span>
