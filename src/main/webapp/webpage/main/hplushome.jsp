...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-5">
        ...
        <br>
        <p>
<!--         	<a class="btn btn-success btn-outline" href="http://yun.BOS.org" target="_blank"> -->
<!--                 <i class="fa fa-cloud"></i> BOS插件下载 -->
<!--             </a> -->
            <a class="btn btn-white btn-bitbucket" href="http://www.BOS.org/forum.php?mod=viewthread&tid=1249&page=1&extra=#pid3689" target="_blank">
                <i class="fa fa-qq"> </i> 联系我们
            </a>
            <a class="btn btn-white btn-bitbucket" href="http://BOS3.mydoc.io" target="_blank">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p><i class="fa fa-send-o"></i> 官网：<a href="http://www.BOS.org" target="_blank">http://www.BOS.org</a>
                    </p>
                                ...
                                <div id="v45" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>日志输出格式修改;</li>
											<li>弹出窗口最大化JS，处理;</li>
                                            <li>BOS云插件下载地址：http://yun.BOS.org </li>
                                            <li>更多插件发布，敬请期待。。</li>
                                        </ol>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                       <div class="alert alert-warning">此版本云应用插件开发版本，支持以插件方式升级平台功能，让我们共同期待后续版本的到来</div>
                                        <ol>
                                            ...
                                            <li>火狐下上传文件bug修复；</li>
                                            <li>用户删除，改成逻辑删除；</li>
                                            <li>BOS云应用平台中心发布：http://yun.BOS.org </li>
                                            <li>插件发布：CMS系统</li>
                                            <li>插件发布：微信企业号管理平台</li>
                                            <li>更多插件发布，敬请期待。。</li>
                                        </ol>
