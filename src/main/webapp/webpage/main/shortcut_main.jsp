...
<%--         <div style="position: absolute; top: 75px; left: 33px;">BOS Framework <span style="letter-spacing: -1px;"> <t:mutiLang langKey="system.version.number"/></span></div> --%>
    </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.bos.org" title="BOS Framework  <t:mutiLang langKey="system.version.number"/>">BOS Framework  <t:mutiLang langKey="system.version.number"/></a>
            (推荐谷歌浏览器，获得更快响应速度) 技术支持:
            <a href="#" title="BOS Framework  <t:mutiLang langKey="system.version.number"/>">BOS Framework  <t:mutiLang langKey="system.version.number"/></a>
        </span>
    </div>
</div>
